        ...
        <>
            <Container className="header" id="header">
                ...
                <Jumbotron fluid className="header_jubo">
                    ...
                    <p>Я очень уважаю постепенные преобразования и стараюсь делать нечто подобное в своей жизни, но меня всегда привлекали революционные перемены. Потому что они труднее. Они эмоционально намного напряжённее. И во время таких перемен ты всегда проходишь через период, когда все говорят тебе, что у тебя ничего не получится.<br></br><br></br>
